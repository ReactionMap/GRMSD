...
qInfo=dir('query'); % store file names to name-attribute
query_num=length(qInfo)-2; % the number of files
tInfo=dir('target'); % store file names to name-attribute
target_num=length(tInfo)-2; % the number of files
